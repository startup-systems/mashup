This project uses the Google Maps API and JavaScript to create an interactive site that brings the user from New York to South Korea to Cape Town and, finally, San Francisco with just a few clicks!
